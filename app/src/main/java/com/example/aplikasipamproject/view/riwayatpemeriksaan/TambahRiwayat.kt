...
fun TambahRiwayatScreen(
    ...
    viewModel: InsertPemeriksaanViewModel = viewModel(factory = PenyediaViewModel.Factory)
) {
        ...
        ConfirmDialogKu(
            onConfirm = {
                ...
                coroutineScope.launch {
                    viewModel.insertPemeriksaan(token = token)
                    onNavigateBack()
                }
            },
        ...
        AppBackgroundColumn(
            ...
            DropDownKu(
                ...
                onOptionSelected = { name ->
                    ...
                    viewModel.updateInsertPemeriksaanState(uiState.detailPemeriksaan.copy(id_hewan = animal?.id_hewan ?: 0))
                }
            )
            ...
            DropDownKu(
                ...
                onOptionSelected = { name ->
                    ...
                    viewModel.updateInsertPemeriksaanState(uiState.detailPemeriksaan.copy(id_layanan = service?.id_layanan ?: 0))
                }
            )
            ...
            DatePickerKu(
                ...
                onDateSelected = { date ->
                    viewModel.updateInsertPemeriksaanState(uiState.detailPemeriksaan.copy(tgl_pemeriksaan = date))
                }
            )

            CustomFormTextField(
                value = uiState.detailPemeriksaan.catatan_medis,
                onValueChange = { viewModel.updateInsertPemeriksaanState(uiState.detailPemeriksaan.copy(catatan_medis = it)) },
                label = "Catatan Medis"
            )
